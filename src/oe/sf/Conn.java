...
public class Conn {
    ...
    public String getUrl() { return serviceEndPoint.substring(0, serviceEndPoint.indexOf(".com")+3); }
    ...
    public static Conn createInstance(String username, String password, boolean useSandboxEndpoint) throws ConnectionException {
        ...
        try {
            ...
            conn.serviceEndPoint = config.getServiceEndpoint();
    ...
    public static Conn getInstance() {
        if (CONN == null || !CONN.isConnected) try {
            throw new ConnectionException("Not connected to Salesforce");
