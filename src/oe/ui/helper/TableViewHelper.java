...
public class TableViewHelper {
    ...
    public static TableColumn[] defineColumns(
            TableView<UiAction> actionTableView,
            Tuple<String, String>[] columnSimpleDefinitions,
        ...
        for(int count=0; count < columnSimpleDefinitions.length; count++){
            ...
            if(count ==9 ){
                tableColumns[count].prefWidthProperty().bind(actionTableView.widthProperty().divide(4));}
